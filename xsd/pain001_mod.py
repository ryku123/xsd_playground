...
class AccountIdentification4Choice_CH(GeneratedsSuper):
    member_data_items_ = {
        'IBAN': MemberSpec_('IBAN', ['IBAN2007Identifier', 'xs:string'], 0),
        'Othr': MemberSpec_('Othr', 'GenericAccountIdentification1-CH', 0),
    }
    subclass = None
    superclass = None
...
class ActiveOrHistoricCurrencyAndAmount(GeneratedsSuper):
    member_data_items_ = {
        'Ccy': MemberSpec_('Ccy', 'ActiveOrHistoricCurrencyCode', 0),
...
class AmountType3Choice(GeneratedsSuper):
    member_data_items_ = {
        'InstdAmt': MemberSpec_('InstdAmt', 'ActiveOrHistoricCurrencyAndAmount', 0),
        'EqvtAmt': MemberSpec_('EqvtAmt', 'EquivalentAmount2', 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='AmountType3Choice', mapping_=None):
        ...
        if self.EqvtAmt is not None:
            EqvtAmt_ = self.EqvtAmt
            EqvtAmt_.to_etree(element, name_='EqvtAmt', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class BranchAndFinancialInstitutionIdentification4(GeneratedsSuper):
    member_data_items_ = {
        'FinInstnId': MemberSpec_('FinInstnId', 'FinancialInstitutionIdentification7', 0),
        'BrnchId': MemberSpec_('BrnchId', 'BranchData2', 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='BranchAndFinancialInstitutionIdentification4', mapping_=None):
        ...
        if self.BrnchId is not None:
            BrnchId_ = self.BrnchId
            BrnchId_.to_etree(element, name_='BrnchId', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class BranchAndFinancialInstitutionIdentification4_CH_BicOrClrId(GeneratedsSuper):
    member_data_items_ = {
        'FinInstnId': MemberSpec_('FinInstnId', 'FinancialInstitutionIdentification7-CH_BicOrClrId', 0),
    }
    subclass = None
    superclass = None
...
class BranchAndFinancialInstitutionIdentification4_CH(GeneratedsSuper):
    member_data_items_ = {
        'FinInstnId': MemberSpec_('FinInstnId', 'FinancialInstitutionIdentification7-CH', 0),
    }
    subclass = None
    superclass = None
    def __init__(self, FinInstnId=None):
...
class BranchData2(GeneratedsSuper):
    member_data_items_ = {
        'Id': MemberSpec_('Id', ['Max35Text', 'BasicText-CH'], 0),
        'Nm': MemberSpec_('Nm', ['Max140Text', 'BasicText-CH'], 0),
        'PstlAdr': MemberSpec_('PstlAdr', 'PostalAddress6', 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='BranchData2', mapping_=None):
        ...
        if self.PstlAdr is not None:
            PstlAdr_ = self.PstlAdr
            PstlAdr_.to_etree(element, name_='PstlAdr', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class CashAccount16_CH_IdAndCurrency(GeneratedsSuper):
    member_data_items_ = {
        'Id': MemberSpec_('Id', 'AccountIdentification4Choice-CH', 0),
        'Ccy': MemberSpec_('Ccy', ['ActiveOrHistoricCurrencyCode', 'xs:string'], 0),
    }
    subclass = None
    superclass = None
...
class CashAccount16_CH_IdTpCcy(GeneratedsSuper):
    member_data_items_ = {
        'Id': MemberSpec_('Id', 'AccountIdentification4Choice-CH', 0),
        'Tp': MemberSpec_('Tp', 'CashAccountType2', 0),
        'Ccy': MemberSpec_('Ccy', ['ActiveOrHistoricCurrencyCode', 'xs:string'], 0),
    }
    subclass = None
    superclass = None
...
class CashAccountType2(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['CashAccountType4Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class CategoryPurpose1_CH_Code(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['ExternalCategoryPurpose1Code', 'xs:string'], 0),
    }
    subclass = None
    superclass = None
...
class Cheque6_CH(GeneratedsSuper):
    member_data_items_ = {
        'ChqTp': MemberSpec_('ChqTp', ['ChequeType2Code', 'xs:string'], 0),
        'DlvryMtd': MemberSpec_('DlvryMtd', 'ChequeDeliveryMethod1Choice', 0),
    }
    subclass = None
    superclass = None
...
class ChequeDeliveryMethod1Choice(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['ChequeDelivery1Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class ClearingSystemIdentification2Choice(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['ExternalClearingSystemIdentification1Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class ClearingSystemMemberIdentification2(GeneratedsSuper):
    member_data_items_ = {
        'ClrSysId': MemberSpec_('ClrSysId', 'ClearingSystemIdentification2Choice', 0),
        'MmbId': MemberSpec_('MmbId', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='ClearingSystemMemberIdentification2', mapping_=None):
        ...
        if self.MmbId is not None:
            MmbId_ = self.MmbId
            MmbId_.to_etree(element, name_='MmbId', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class ContactDetails2(GeneratedsSuper):
    member_data_items_ = {
        'NmPrfx': MemberSpec_('NmPrfx', ['NamePrefix1Code', 'xs:string'], 0),
        'Nm': MemberSpec_('Nm', ['Max140Text', 'BasicText-CH'], 0),
        'PhneNb': MemberSpec_('PhneNb', ['PhoneNumber', 'xs:string'], 0),
        'MobNb': MemberSpec_('MobNb', ['PhoneNumber', 'xs:string'], 0),
        'FaxNb': MemberSpec_('FaxNb', ['PhoneNumber', 'xs:string'], 0),
        'EmailAdr': MemberSpec_('EmailAdr', ['Max2048Text', 'BasicText-CH'], 0),
...
class CreditTransferTransactionInformation10_CH(GeneratedsSuper):
    member_data_items_ = {
        'PmtId': MemberSpec_('PmtId', 'PaymentIdentification1', 0),
        'PmtTpInf': MemberSpec_('PmtTpInf', 'PaymentTypeInformation19-CH', 0),
        'Amt': MemberSpec_('Amt', 'AmountType3Choice', 0),
        'XchgRateInf': MemberSpec_('XchgRateInf', 'ExchangeRateInformation1', 0),
        'ChrgBr': MemberSpec_('ChrgBr', ['ChargeBearerType1Code', 'xs:string'], 0),
        'ChqInstr': MemberSpec_('ChqInstr', 'Cheque6-CH', 0),
        'UltmtDbtr': MemberSpec_('UltmtDbtr', 'PartyIdentification32-CH', 0),
        'IntrmyAgt1': MemberSpec_('IntrmyAgt1', 'BranchAndFinancialInstitutionIdentification4-CH', 0),
        'CdtrAgt': MemberSpec_('CdtrAgt', 'BranchAndFinancialInstitutionIdentification4-CH', 0),
        'Cdtr': MemberSpec_('Cdtr', 'PartyIdentification32-CH_Name', 0),
        'CdtrAcct': MemberSpec_('CdtrAcct', 'CashAccount16-CH_Id', 0),
        'UltmtCdtr': MemberSpec_('UltmtCdtr', 'PartyIdentification32-CH_Name', 0),
        'InstrForCdtrAgt': MemberSpec_('InstrForCdtrAgt', 'InstructionForCreditorAgent1', 1),
        'InstrForDbtrAgt': MemberSpec_('InstrForDbtrAgt', ['Max140Text', 'BasicText-CH'], 0),
        'Purp': MemberSpec_('Purp', 'Purpose2-CH_Code', 0),
        'RgltryRptg': MemberSpec_('RgltryRptg', 'RegulatoryReporting3', 1),
        'RmtInf': MemberSpec_('RmtInf', 'RemittanceInformation5-CH', 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='CreditTransferTransactionInformation10-CH', mapping_=None):
        ...
        if self.IntrmyAgt1 is not None:
            IntrmyAgt1_ = self.IntrmyAgt1
            IntrmyAgt1_.to_etree(element, name_='IntrmyAgt1', mapping_=mapping_)
        if self.CdtrAgt is not None:
            CdtrAgt_ = self.CdtrAgt
            CdtrAgt_.to_etree(element, name_='CdtrAgt', mapping_=mapping_)
        if self.Cdtr is not None:
            Cdtr_ = self.Cdtr
            Cdtr_.to_etree(element, name_='Cdtr', mapping_=mapping_)
        if self.CdtrAcct is not None:
            CdtrAcct_ = self.CdtrAcct
            CdtrAcct_.to_etree(element, name_='CdtrAcct', mapping_=mapping_)
        if self.UltmtCdtr is not None:
            UltmtCdtr_ = self.UltmtCdtr
            UltmtCdtr_.to_etree(element, name_='UltmtCdtr', mapping_=mapping_)
        for InstrForCdtrAgt_ in self.InstrForCdtrAgt:
            InstrForCdtrAgt_.to_etree(element, name_='InstrForCdtrAgt', mapping_=mapping_)
        if self.InstrForDbtrAgt is not None:
            InstrForDbtrAgt_ = self.InstrForDbtrAgt
            InstrForDbtrAgt_.to_etree(element, name_='InstrForDbtrAgt', mapping_=mapping_)
        if self.Purp is not None:
            Purp_ = self.Purp
            Purp_.to_etree(element, name_='Purp', mapping_=mapping_)
        for RgltryRptg_ in self.RgltryRptg:
            RgltryRptg_.to_etree(element, name_='RgltryRptg', mapping_=mapping_)
        if self.RmtInf is not None:
            RmtInf_ = self.RmtInf
            RmtInf_.to_etree(element, name_='RmtInf', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class CreditorReferenceInformation2(GeneratedsSuper):
    member_data_items_ = {
        'Tp': MemberSpec_('Tp', 'CreditorReferenceType2', 0),
        'Ref': MemberSpec_('Ref', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='CreditorReferenceInformation2', mapping_=None):
        ...
        if self.Ref is not None:
            Ref_ = self.Ref
            Ref_.to_etree(element, name_='Ref', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class CreditorReferenceType1Choice(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['DocumentType3Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class CreditorReferenceType2(GeneratedsSuper):
    member_data_items_ = {
        'CdOrPrtry': MemberSpec_('CdOrPrtry', 'CreditorReferenceType1Choice', 0),
        'Issr': MemberSpec_('Issr', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='CreditorReferenceType2', mapping_=None):
        ...
        if self.Issr is not None:
            Issr_ = self.Issr
            Issr_.to_etree(element, name_='Issr', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class DocumentAdjustment1(GeneratedsSuper):
    member_data_items_ = {
        'Amt': MemberSpec_('Amt', 'ActiveOrHistoricCurrencyAndAmount', 0),
        'CdtDbtInd': MemberSpec_('CdtDbtInd', ['CreditDebitCode', 'xs:string'], 0),
        'Rsn': MemberSpec_('Rsn', ['Max4Text', 'BasicText-CH'], 0),
        'AddtlInf': MemberSpec_('AddtlInf', ['Max140Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='DocumentAdjustment1', mapping_=None):
        ...
        if self.AddtlInf is not None:
            AddtlInf_ = self.AddtlInf
            AddtlInf_.to_etree(element, name_='AddtlInf', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class EquivalentAmount2(GeneratedsSuper):
    member_data_items_ = {
        'Amt': MemberSpec_('Amt', 'ActiveOrHistoricCurrencyAndAmount', 0),
        'CcyOfTrf': MemberSpec_('CcyOfTrf', ['ActiveOrHistoricCurrencyCode', 'xs:string'], 0),
    }
    subclass = None
    superclass = None
...
class ExchangeRateInformation1(GeneratedsSuper):
    member_data_items_ = {
        'XchgRate': MemberSpec_('XchgRate', ['BaseOneRate', 'xs:decimal'], 0),
        'RateTp': MemberSpec_('RateTp', ['ExchangeRateType1Code', 'xs:string'], 0),
        'CtrctId': MemberSpec_('CtrctId', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class FinancialIdentificationSchemeName1Choice(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['ExternalFinancialInstitutionIdentification1Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class FinancialInstitutionIdentification7(GeneratedsSuper):
    member_data_items_ = {
        'BIC': MemberSpec_('BIC', ['BICIdentifier', 'xs:string'], 0),
        'ClrSysMmbId': MemberSpec_('ClrSysMmbId', 'ClearingSystemMemberIdentification2', 0),
        'Nm': MemberSpec_('Nm', ['Max140Text', 'BasicText-CH'], 0),
        'PstlAdr': MemberSpec_('PstlAdr', 'PostalAddress6', 0),
        'Othr': MemberSpec_('Othr', 'GenericFinancialIdentification1', 0),
    }
    subclass = None
    superclass = None
...
class FinancialInstitutionIdentification7_CH(GeneratedsSuper):
    member_data_items_ = {
        ...
        'ClrSysMmbId': MemberSpec_('ClrSysMmbId', 'ClearingSystemMemberIdentification2', 0),
        'Nm': MemberSpec_('Nm', ['Max70Text', 'BasicText-CH'], 0),
        'PstlAdr': MemberSpec_('PstlAdr', 'PostalAddress6-CH', 0),
        'Othr': MemberSpec_('Othr', 'GenericFinancialIdentification1-CH', 0),
    }
    subclass = None
    superclass = None
    def __init__(self, BIC=None, ClrSysMmbId=None, Nm=None, PstlAdr=None, Othr=None):
...
class GenericAccountIdentification1_CH(GeneratedsSuper):
    member_data_items_ = {
        'Id': MemberSpec_('Id', ['Max34Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
    def __init__(self, Id=None):
...
class GenericFinancialIdentification1(GeneratedsSuper):
    member_data_items_ = {
        'Id': MemberSpec_('Id', ['Max35Text', 'BasicText-CH'], 0),
        'SchmeNm': MemberSpec_('SchmeNm', 'FinancialIdentificationSchemeName1Choice', 0),
        'Issr': MemberSpec_('Issr', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='GenericFinancialIdentification1', mapping_=None):
        ...
        if self.Id is not None:
            ...
            Id_.to_etree(element, name_='Id', mapping_=mapping_)
        if self.SchmeNm is not None:
            SchmeNm_ = self.SchmeNm
            SchmeNm_.to_etree(element, name_='SchmeNm', mapping_=mapping_)
        if self.Issr is not None:
            Issr_ = self.Issr
            Issr_.to_etree(element, name_='Issr', mapping_=mapping_)
        if mapping_ is not None:
...
class GenericOrganisationIdentification1(GeneratedsSuper):
    member_data_items_ = {
        'Id': MemberSpec_('Id', ['Max35Text', 'BasicText-CH'], 0),
        'SchmeNm': MemberSpec_('SchmeNm', 'OrganisationIdentificationSchemeName1Choice', 0),
        'Issr': MemberSpec_('Issr', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class GenericPersonIdentification1(GeneratedsSuper):
    member_data_items_ = {
        'Id': MemberSpec_('Id', ['Max35Text', 'BasicText-CH'], 0),
        'SchmeNm': MemberSpec_('SchmeNm', 'PersonIdentificationSchemeName1Choice', 0),
        'Issr': MemberSpec_('Issr', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class GroupHeader32_CH(GeneratedsSuper):
    member_data_items_ = {
        ...
        'FwdgAgt': MemberSpec_('FwdgAgt', 'BranchAndFinancialInstitutionIdentification4', 0),
    }
    subclass = None
    superclass = None
...
class InstructionForCreditorAgent1(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['Instruction3Code', 'xs:string'], 0),
        'InstrInf': MemberSpec_('InstrInf', ['Max140Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class LocalInstrument2Choice(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['ExternalLocalInstrument1Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class OrganisationIdentification4(GeneratedsSuper):
    member_data_items_ = {
        ...
        'Othr': MemberSpec_('Othr', 'GenericOrganisationIdentification1', 1),
    }
    subclass = None
    superclass = None
...
class OrganisationIdentification4_CH(GeneratedsSuper):
    member_data_items_ = {
        'BICOrBEI': MemberSpec_('BICOrBEI', ['AnyBICIdentifier', 'xs:string'], 0),
        'Othr': MemberSpec_('Othr', 'GenericOrganisationIdentification1', 0),
    }
    subclass = None
    superclass = None
    def __init__(self, BICOrBEI=None, Othr=None):
...
class OrganisationIdentificationSchemeName1Choice(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['ExternalOrganisationIdentification1Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class Party6Choice(GeneratedsSuper):
    member_data_items_ = {
        'OrgId': MemberSpec_('OrgId', 'OrganisationIdentification4', 0),
        'PrvtId': MemberSpec_('PrvtId', 'PersonIdentification5', 0),
    }
    subclass = None
    superclass = None
...
class PartyIdentification32(GeneratedsSuper):
    member_data_items_ = {
        'Nm': MemberSpec_('Nm', ['Max140Text', 'BasicText-CH'], 0),
        'PstlAdr': MemberSpec_('PstlAdr', 'PostalAddress6', 0),
        'Id': MemberSpec_('Id', 'Party6Choice', 0),
        'CtryOfRes': MemberSpec_('CtryOfRes', ['CountryCode', 'xs:string'], 0),
        'CtctDtls': MemberSpec_('CtctDtls', 'ContactDetails2', 0),
    }
    subclass = None
    superclass = None
...
class PaymentInstructionInformation3_CH(GeneratedsSuper):
    member_data_items_ = {
        ...
        'Dbtr': MemberSpec_('Dbtr', 'PartyIdentification32-CH', 0),
        'DbtrAcct': MemberSpec_('DbtrAcct', 'CashAccount16-CH_IdTpCcy', 0),
        'DbtrAgt': MemberSpec_('DbtrAgt', 'BranchAndFinancialInstitutionIdentification4-CH_BicOrClrId', 0),
        'UltmtDbtr': MemberSpec_('UltmtDbtr', 'PartyIdentification32-CH', 0),
        'ChrgBr': MemberSpec_('ChrgBr', ['ChargeBearerType1Code', 'xs:string'], 0),
        'ChrgsAcct': MemberSpec_('ChrgsAcct', 'CashAccount16-CH_IdAndCurrency', 0),
        'CdtTrfTxInf': MemberSpec_('CdtTrfTxInf', 'CreditTransferTransactionInformation10-CH', 1),
    }
    subclass = None
    superclass = None
...
class PaymentTypeInformation19_CH(GeneratedsSuper):
    member_data_items_ = {
        'InstrPrty': MemberSpec_('InstrPrty', ['Priority2Code', 'xs:string'], 0),
        'SvcLvl': MemberSpec_('SvcLvl', 'ServiceLevel8Choice', 0),
        'LclInstrm': MemberSpec_('LclInstrm', 'LocalInstrument2Choice', 0),
        'CtgyPurp': MemberSpec_('CtgyPurp', 'CategoryPurpose1-CH_Code', 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='PaymentTypeInformation19-CH', mapping_=None):
        ...
        if self.LclInstrm is not None:
            LclInstrm_ = self.LclInstrm
            LclInstrm_.to_etree(element, name_='LclInstrm', mapping_=mapping_)
        if self.CtgyPurp is not None:
            CtgyPurp_ = self.CtgyPurp
            CtgyPurp_.to_etree(element, name_='CtgyPurp', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class PersonIdentification5(GeneratedsSuper):
    member_data_items_ = {
        ...
        'Othr': MemberSpec_('Othr', 'GenericPersonIdentification1', 1),
    }
    subclass = None
    superclass = None
...
class PersonIdentification5_CH(GeneratedsSuper):
    member_data_items_ = {
        'DtAndPlcOfBirth': MemberSpec_('DtAndPlcOfBirth', 'DateAndPlaceOfBirth', 0),
        'Othr': MemberSpec_('Othr', 'GenericPersonIdentification1', 0),
    }
    subclass = None
    superclass = None
    def __init__(self, DtAndPlcOfBirth=None, Othr=None):
...
class PersonIdentificationSchemeName1Choice(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['ExternalPersonIdentification1Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class PostalAddress6(GeneratedsSuper):
    member_data_items_ = {
        'AdrTp': MemberSpec_('AdrTp', ['AddressType2Code', 'xs:string'], 0),
        'Dept': MemberSpec_('Dept', ['Max70Text', 'BasicText-CH'], 0),
        'SubDept': MemberSpec_('SubDept', ['Max70Text', 'BasicText-CH'], 0),
        'StrtNm': MemberSpec_('StrtNm', ['Max70Text', 'BasicText-CH'], 0),
        'BldgNb': MemberSpec_('BldgNb', ['Max16Text', 'BasicText-CH'], 0),
        'PstCd': MemberSpec_('PstCd', ['Max16Text', 'BasicText-CH'], 0),
        'TwnNm': MemberSpec_('TwnNm', ['Max35Text', 'BasicText-CH'], 0),
        'CtrySubDvsn': MemberSpec_('CtrySubDvsn', ['Max35Text', 'BasicText-CH'], 0),
        'Ctry': MemberSpec_('Ctry', ['CountryCode', 'xs:string'], 0),
        'AdrLine': MemberSpec_('AdrLine', ['Max70Text', 'BasicText-CH'], 1),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='PostalAddress6', mapping_=None):
        ...
        if self.SubDept is not None:
            SubDept_ = self.SubDept
            SubDept_.to_etree(element, name_='SubDept', mapping_=mapping_)
        if self.StrtNm is not None:
            StrtNm_ = self.StrtNm
            StrtNm_.to_etree(element, name_='StrtNm', mapping_=mapping_)
        if self.BldgNb is not None:
            BldgNb_ = self.BldgNb
            BldgNb_.to_etree(element, name_='BldgNb', mapping_=mapping_)
        if self.PstCd is not None:
            PstCd_ = self.PstCd
            PstCd_.to_etree(element, name_='PstCd', mapping_=mapping_)
        if self.TwnNm is not None:
            TwnNm_ = self.TwnNm
            TwnNm_.to_etree(element, name_='TwnNm', mapping_=mapping_)
        if self.CtrySubDvsn is not None:
            CtrySubDvsn_ = self.CtrySubDvsn
...
class Purpose2_CH_Code(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['ExternalPurpose1Code', 'xs:string'], 0),
    }
    subclass = None
    superclass = None
    def __init__(self, Cd=None):
...
class ReferredDocumentInformation3(GeneratedsSuper):
    member_data_items_ = {
        'Tp': MemberSpec_('Tp', 'ReferredDocumentType2', 0),
        'Nb': MemberSpec_('Nb', ['Max35Text', 'BasicText-CH'], 0),
        'RltdDt': MemberSpec_('RltdDt', ['ISODate', 'xs:date'], 0),
    }
    subclass = None
    superclass = None
...
class ReferredDocumentType1Choice(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['DocumentType5Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class ReferredDocumentType2(GeneratedsSuper):
    member_data_items_ = {
        'CdOrPrtry': MemberSpec_('CdOrPrtry', 'ReferredDocumentType1Choice', 0),
        'Issr': MemberSpec_('Issr', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class RegulatoryReporting3(GeneratedsSuper):
    member_data_items_ = {
        'DbtCdtRptgInd': MemberSpec_('DbtCdtRptgInd', ['RegulatoryReportingType1Code', 'xs:string'], 0),
        'Authrty': MemberSpec_('Authrty', 'RegulatoryAuthority2', 0),
        'Dtls': MemberSpec_('Dtls', 'StructuredRegulatoryReporting3', 1),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='RegulatoryReporting3', mapping_=None):
        ...
        for Dtls_ in self.Dtls:
            Dtls_.to_etree(element, name_='Dtls', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class RemittanceAmount1(GeneratedsSuper):
    member_data_items_ = {
        'DuePyblAmt': MemberSpec_('DuePyblAmt', 'ActiveOrHistoricCurrencyAndAmount', 0),
        'DscntApldAmt': MemberSpec_('DscntApldAmt', 'ActiveOrHistoricCurrencyAndAmount', 0),
        'CdtNoteAmt': MemberSpec_('CdtNoteAmt', 'ActiveOrHistoricCurrencyAndAmount', 0),
        'TaxAmt': MemberSpec_('TaxAmt', 'ActiveOrHistoricCurrencyAndAmount', 0),
        'AdjstmntAmtAndRsn': MemberSpec_('AdjstmntAmtAndRsn', 'DocumentAdjustment1', 1),
        'RmtdAmt': MemberSpec_('RmtdAmt', 'ActiveOrHistoricCurrencyAndAmount', 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='RemittanceAmount1', mapping_=None):
        ...
        if self.DscntApldAmt is not None:
            DscntApldAmt_ = self.DscntApldAmt
            DscntApldAmt_.to_etree(element, name_='DscntApldAmt', mapping_=mapping_)
        if self.CdtNoteAmt is not None:
            CdtNoteAmt_ = self.CdtNoteAmt
            CdtNoteAmt_.to_etree(element, name_='CdtNoteAmt', mapping_=mapping_)
        if self.TaxAmt is not None:
            TaxAmt_ = self.TaxAmt
            TaxAmt_.to_etree(element, name_='TaxAmt', mapping_=mapping_)
        for AdjstmntAmtAndRsn_ in self.AdjstmntAmtAndRsn:
            AdjstmntAmtAndRsn_.to_etree(element, name_='AdjstmntAmtAndRsn', mapping_=mapping_)
        if self.RmtdAmt is not None:
            RmtdAmt_ = self.RmtdAmt
            RmtdAmt_.to_etree(element, name_='RmtdAmt', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class RemittanceInformation5_CH(GeneratedsSuper):
    member_data_items_ = {
        'Ustrd': MemberSpec_('Ustrd', ['Max140Text', 'BasicText-CH'], 0),
        'Strd': MemberSpec_('Strd', 'StructuredRemittanceInformation7', 0),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='RemittanceInformation5-CH', mapping_=None):
        ...
        if self.Strd is not None:
            Strd_ = self.Strd
            Strd_.to_etree(element, name_='Strd', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class ServiceLevel8Choice(GeneratedsSuper):
    member_data_items_ = {
        'Cd': MemberSpec_('Cd', ['ExternalServiceLevel1Code', 'xs:string'], 0),
        'Prtry': MemberSpec_('Prtry', ['Max35Text', 'BasicText-CH'], 0),
    }
    subclass = None
    superclass = None
...
class StructuredRegulatoryReporting3(GeneratedsSuper):
    member_data_items_ = {
        'Tp': MemberSpec_('Tp', ['Max35Text', 'BasicText-CH'], 0),
        'Dt': MemberSpec_('Dt', ['ISODate', 'xs:date'], 0),
        'Ctry': MemberSpec_('Ctry', ['CountryCode', 'xs:string'], 0),
        'Cd': MemberSpec_('Cd', ['Max10Text', 'BasicText-CH'], 0),
        'Amt': MemberSpec_('Amt', 'ActiveOrHistoricCurrencyAndAmount', 0),
        'Inf': MemberSpec_('Inf', ['Max35Text', 'BasicText-CH'], 1),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='StructuredRegulatoryReporting3', mapping_=None):
        ...
        if self.Amt is not None:
            ...
            Amt_.to_etree(element, name_='Amt', mapping_=mapping_)
        for Inf_ in self.Inf:
            Inf_.to_etree(element, name_='Inf', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class StructuredRemittanceInformation7(GeneratedsSuper):
    member_data_items_ = {
        'RfrdDocInf': MemberSpec_('RfrdDocInf', 'ReferredDocumentInformation3', 1),
        'RfrdDocAmt': MemberSpec_('RfrdDocAmt', 'RemittanceAmount1', 0),
        'CdtrRefInf': MemberSpec_('CdtrRefInf', 'CreditorReferenceInformation2', 0),
        'Invcr': MemberSpec_('Invcr', 'PartyIdentification32', 0),
        'Invcee': MemberSpec_('Invcee', 'PartyIdentification32', 0),
        'AddtlRmtInf': MemberSpec_('AddtlRmtInf', ['Max140Text', 'BasicText-CH'], 1),
    }
    subclass = None
    superclass = None
    ...
    def to_etree(self, parent_element=None, name_='StructuredRemittanceInformation7', mapping_=None):
        ...
        if self.RfrdDocAmt is not None:
            RfrdDocAmt_ = self.RfrdDocAmt
            RfrdDocAmt_.to_etree(element, name_='RfrdDocAmt', mapping_=mapping_)
        if self.CdtrRefInf is not None:
            CdtrRefInf_ = self.CdtrRefInf
            CdtrRefInf_.to_etree(element, name_='CdtrRefInf', mapping_=mapping_)
        if self.Invcr is not None:
            Invcr_ = self.Invcr
            Invcr_.to_etree(element, name_='Invcr', mapping_=mapping_)
        if self.Invcee is not None:
            Invcee_ = self.Invcee
            Invcee_.to_etree(element, name_='Invcee', mapping_=mapping_)
        for AddtlRmtInf_ in self.AddtlRmtInf:
            AddtlRmtInf_.to_etree(element, name_='AddtlRmtInf', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
